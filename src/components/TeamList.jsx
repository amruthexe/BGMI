...
return(
    ...
    <h1 className='bg-black text-white text-center'>  Teams and Players Enrolled Details</h1>
    <h1 className='bg-black text-white text-center font-bold  pb-4 '>Will be announced soon</h1>
    <img src="img/image.jpg" alt="soon" />
    </>
)
};
